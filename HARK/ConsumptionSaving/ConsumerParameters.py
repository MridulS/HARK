...
init_kinked_R[
    "CubicBool"
] = False  # kinked R currently only compatible with linear cFunc
init_kinked_R[
    "aXtraCount"
] = 48  # ...so need lots of extra gridpoints to make up for it
...
init_preference_shocks[
    "CubicBool"
] = False  # pref shocks currently only compatible with linear cFunc
