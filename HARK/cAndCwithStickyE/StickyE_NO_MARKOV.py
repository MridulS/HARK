...
def main():
    ...
    if do_SOE:
        if run_models:
            ...
            StickySOEconomy = SmallOpenEconomy(
                agents=StickySOEconsumers, **Params.init_SOE_market
            )
            ...
            t_end = clock()
            print(
                "Solving the small open economy took "
                + str(t_end - t_start)
                + " seconds."
            )
            ...
            cFunc = (
                lambda m: StickySOEconsumers[0].solution[0].cFunc(m, np.ones_like(m))
            )
            ...
            t_end = clock()
            print(
                "Simulating the frictionless small open economy took "
                + mystr(t_end - t_start)
                + " seconds."
            )
            ...
            t_end = clock()
            print(
                "Simulating the sticky small open economy took "
                + mystr(t_end - t_start)
                + " seconds."
            )
            ...
            desc = (
                "Results for the sticky small open economy with update probability "
        ...
        if make_tables:
            ...
            frictionless_panel = runRegressions(
                "SOEsimpleFrictionlessData", interval_size, False, False, False
            )
            frictionless_me_panel = runRegressions(
                "SOEsimpleFrictionlessData", interval_size, True, False, False
            )
            sticky_panel = runRegressions(
                "SOEsimpleStickyData", interval_size, False, True, False
            )
            sticky_me_panel = runRegressions(
                "SOEsimpleStickyData", interval_size, True, True, False
            )
            makeResultsTable(
                "Aggregate Consumption Dynamics in SOE Model",
                [frictionless_me_panel, sticky_panel, sticky_me_panel],
                my_counts,
                "SOEsimReg",
                "tPESOEsim",
            )
            t_end = clock()
            print(
                "Running time series regressions for the small open economy took "
                + mystr(t_end - t_start)
                + " seconds."
            )
    ...
    if do_DSGE:
        if run_models:
            ...
            StickyDSGEeconomy = StickyCobbDouglasEconomy(
                agents=StickyDSGEconsumers, **Params.init_DSGE_market
            )
            ...
            t_end = clock()
            print(
                "Solving the frictionless Cobb-Douglas economy took "
                + mystr(t_end - t_start)
                + " seconds."
            )
            ...
            t_end = clock()
            print(
                "Solving the sticky Cobb-Douglas economy took "
                + mystr(t_end - t_start)
                + " seconds."
            )
            ...
            desc = (
                "Results for the sticky Cobb-Douglas economy with update probability "
                + mystr(Params.UpdatePrb)
            )
        ...
        if make_tables:
            t_start = clock()
            frictionless_panel = runRegressions(
                "DSGEsimpleFrictionlessData", interval_size, False, False, False
            )
            frictionless_me_panel = runRegressions(
                "DSGEsimpleFrictionlessData", interval_size, True, False, False
            )
            sticky_panel = runRegressions(
                "DSGEsimpleStickyData", interval_size, False, True, False
            )
            sticky_me_panel = runRegressions(
                "DSGEsimpleStickyData", interval_size, True, True, False
            )
            makeResultsTable(
            ...
            t_end = clock()
            print(
                "Running time series regressions for the Cobb-Douglas economy took "
                + mystr(t_end - t_start)
                + " seconds."
            )
    ...
    if do_RA:
        if run_models:
            ...
            t_end = clock()
            print(
                "Solving the representative agent economy took "
                + mystr(t_end - t_start)
                + " seconds."
            )
            ...
            t_end = clock()
            print(
                "Simulating the frictionless representative agent economy took "
                + mystr(t_end - t_start)
                + " seconds."
            )
            ...
            t_end = clock()
            print(
                "Simulating the sticky representative agent economy took "
                + mystr(t_end - t_start)
                + " seconds."
            )
            ...
            desc = (
                "Results for the sticky representative agent economy with update probability "
                + mystr(Params.UpdatePrb)
            )
            name = "RAsimpleSticky"
            makeStickyEdataFile(
        ...
        if make_tables:
            ...
            t_start = clock()
            frictionless_panel = runRegressions(
                "RAsimpleFrictionlessData", interval_size, False, False, False
            )
            frictionless_me_panel = runRegressions(
                "RAsimpleFrictionlessData", interval_size, True, False, False
            )
            sticky_panel = runRegressions(
                "RAsimpleStickyData", interval_size, False, True, False
            )
            sticky_me_panel = runRegressions(
                "RAsimpleStickyData", interval_size, True, True, False
            )
            makeResultsTable(
            ...
            t_end = clock()
            print(
                "Running time series regressions for the representative agent economy took "
                + mystr(t_end - t_start)
                + " seconds."
            )
