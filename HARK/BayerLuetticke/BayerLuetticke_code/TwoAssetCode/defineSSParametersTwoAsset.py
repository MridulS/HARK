...
par["xi"] = 4.0  # CRRA
par["gamma"] = 1.0  # Inverse Frisch elasticity
...
par["alpha"] = (2.0 / 3.0) / par["mu"]  # Labor share 2/3
par["delta"] = 0.054 / 4.0  # Depreciation rate
...
par["kappa"] = (
    (1.0 - par["prob_priceadj"])
    * (1.0 - par["prob_priceadj"] * par["beta"])
    / par["prob_priceadj"]
...
par["borrwedge"] = par["PI"] * (
    1.1 ** 0.25 - 1
)  # Wedge on borrowing beyond secured borrowing
